...
{
    JRB node2;
    jrb_traverse(node2,graph.edges)
    {
        delEdge(graph,jval_i(node2->key),v,0);
    }
...
// flag =1 neu do thi vo huong flag = 0 neu do thi co huong
...
{
    delEdge(graph,v1,v2,flag);
    addEdge(graph,v1,v2,n_weight,flag);
}
